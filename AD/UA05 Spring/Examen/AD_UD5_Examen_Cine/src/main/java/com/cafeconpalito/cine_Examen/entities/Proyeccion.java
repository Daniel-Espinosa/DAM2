 ...
 */
package com.cafeconpalito.cine_Examen.entities;
...
public class Proyeccion implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "fkproyeccion")
    ...
    public String toString() {
        return "com.cafeconpalito.cine_Examen.entities.Proyeccion[ pkproyeccion=" + pkproyeccion + " ]";
    }
