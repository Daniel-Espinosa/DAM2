...
public class Persona implements Serializable {
    ...
    /**
     * Constructor por si la DB tiene autoincrement en la PK
     * @param nombre
     * @param fechanacimiento
     * @param ndosis 
     */
    public Persona(String nombre, Date fechanacimiento, Integer ndosis) {
        //this.pkpersona = pkpersona;
        this.nombre = nombre;
        this.fechanacimiento = fechanacimiento;
        this.ndosis = ndosis;
    ...
    public String toString() {
        return "com.cafeconpalito.AD_UD5_Tarea2_Vacunas.Entities.Persona[ pkpersona=" + pkpersona + " ]";
    }
