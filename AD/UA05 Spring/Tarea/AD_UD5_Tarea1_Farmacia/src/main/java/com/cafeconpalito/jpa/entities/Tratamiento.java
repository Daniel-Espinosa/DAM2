 ...
 */
package com.cafeconpalito.jpa.entities;
...
public class Tratamiento implements Serializable {
    ...
    //MI CONSTRUCTOR
    public Tratamiento(Integer pktratamiento, Date fecha, Medicamento akmedicina, Persona akpersona) {
        this.pktratamiento = pktratamiento;
        this.fecha = fecha;
    ...
    public String toString() {
        return "com.cafeconpalito.jpa.entities.Tratamiento[ pktratamiento=" + pktratamiento + " ]";
    }
